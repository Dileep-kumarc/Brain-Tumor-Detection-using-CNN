...
def load_models():
    ...
    # Load Tumor Segmentation Model (UNet)
    ...
    return custom_cnn_model, classifier_model, segmentation_model
...
custom_cnn_model, classifier_model, segmentation_model = load_models()
...
if uploaded_file:
    ...
    if not is_mri:
        ...
        if tumor_type != "No Tumor":
            ...
            with col2:
                plt.figure(figsize=(4, 4))  # Adjust size here
